...
class BenchmarkPlotter:
    ...
    def plot_iteration_tokens_hist(self, ax=None, **kwargs):
        self.plot_hist("vllm:iteration_tokens_total_bucket", include_inf=True, ax=ax, **kwargs)

    def plot_time_per_output_token_hist(self, ax=None,  **kwargs):
        self.plot_hist("vllm:time_per_output_token_seconds_bucket", include_inf=True, ax=ax,  **kwargs)

    def plot_time_to_first_token_hist(self, ax=None,  **kwargs):
        self.plot_hist("vllm:time_to_first_token_seconds_bucket", include_inf=True, ax=ax, **kwargs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("prometheus_url", type=str, help="Prometheus server URL.")
